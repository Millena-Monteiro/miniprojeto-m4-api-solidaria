import Doador from '../models/doadoresModel.js'; // Importa o modelo de doador
...
export const listarDoadores = async (req, res) => {
  try {
    ...
    res.status(200).json(doadores); // Retorna os doadores com status 200
  } catch (error) {
...
if (!emailValido) {
  ...
  try {
    ...
    await novoDoador.save(); // Salva o novo doador
